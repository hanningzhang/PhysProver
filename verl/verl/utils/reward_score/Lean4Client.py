from verl.utils.reward_score.util import utils
...
class Lean4Client:
    ...
    def _crearte_temp_file(
        ...
        temp_folder = os.path.join(self.lean4_project_path, tmp_folder)
    ...
    def verify(
        ...
        utils.check_folder_exit(os.path.join(self.lean4_project_path, tmp_folder))
        ...
        # create temp files
        codes_with_temp_files = self._crearte_temp_file(codes, tmp_folder)
